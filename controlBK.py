...
#plot_neutrino_branching(pfit,t_0,Fits,fpf0same,Nijk,Npow,Nm,addrho,constraint2)
...
#plot_C7_C9(pfit,t_0,Fits,fpf0same,Nijk,Npow,Nm,addrho,constraint2,B='0')
#plot_C7_C9(pfit,t_0,Fits,fpf0same,Nijk,Npow,Nm,addrho,constraint2,B='p')
##########################
...
#f0_fp_fT_in_Mh_log4GeV(pfit,Fits,t_0,Nijk,Npow,Nm,addrho,fpf0same,constraint2)
#f0_fp_fT_in_Mh_deriv4GeV(pfit,Fits,t_0,Nijk,Npow,Nm,addrho,fpf0same,constraint2)
#f0_fp_fT_in_Mh_deriv2_4GeV(pfit,Fits,t_0,Nijk,Npow,Nm,addrho,fpf0same,constraint2)
